...
exports.createComplaint = async (req, res) => {
  try {
    ...
    try {
      ...
      complaint.blockNumber = blockchainResult.blockNumber;
      complaint.onChain = true;
      await complaint.save();

      console.log(`✅ Complaint ${complaint._id} registered on blockchain: ${blockchainResult.transactionId}`);
